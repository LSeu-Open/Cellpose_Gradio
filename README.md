...
* This application is based on the **[Cellpose library](https://github.com/mouseland/cellpose)**. If you find it useful in your research, please cite the following papers:
...
* This application is build using the **[Gradio Package](https://www.gradio.app/)**. If you use it for your research, please consider cite this paper :

**Gradio: Build Machine Learning Web Apps — in Python [paper](https://arxiv.org/abs/1906.02569)**
Abubakar Abid, Ali Abdalla, Ali Abid, Dawood Khan, Abdulrahman Alfozan, James Y. Zou (2019) Gradio: Hassle-Free Sharing and Testing of ML Models in the Wild. bioRxiv.
